...
const wrapSecp256k1Wasm = (
  ...
  batchpubkeyCreate: (contextPtr, tweakNumBatchPtr, publicKeyPtrOne, publicKeyPtrTwo) =>
    (instance.exports as any)._secp256k1_ec_pubkey_pub_add_batch(
      contextPtr,
      tweakNumBatchPtr,
      publicKeyPtrOne,
      publicKeyPtrTwo
