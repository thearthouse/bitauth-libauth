...
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_ec_pubkey_pub_add(
    const secp256k1_context* ctx,
    secp256k1_pubkey *pubkey,
    const secp256k1_pubkey *loin
) SECP256K1_ARG_NONNULL(1);

SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_ec_pubkey_pub_add_batch(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API bigole_scratch* demo_create(
    const secp256k1_context* ctx,
    const size_t size
) SECP256K1_WARN_UNUSED_RESULT;
